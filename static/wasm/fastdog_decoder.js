 ...
 * @returns {any}
 */
export function decode_fastdog_binary(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_fastdog_binary(ptr0, len0);
    return ret;
}
...
export function validate_fastdog_format(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_fastdog_format(ptr0, len0);
    return ret !== 0;
}
 ...
 * @returns {any}
 */
export function get_format_info(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_format_info(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function benchmark_decode(data, iterations) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.benchmark_decode(ptr0, len0, iterations);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('fastdog_decoder_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
